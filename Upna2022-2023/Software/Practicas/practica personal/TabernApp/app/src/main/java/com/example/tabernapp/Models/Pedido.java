...
public class Pedido extends ParseObject {
    ...
    // Getters and setters
    public void setPreparado(boolean preparado) { put("preparado", preparado); }

    public boolean getPreparado() {
        try {
            ParseQuery<ParseObject> query = ParseQuery.getQuery("Pedido");
            return query.get(this.getObjectId()).getBoolean("preparado");
    ...
    public Direccion getDireccionRecogida() {
        ...
        return (Direccion) p.getParseObject("direccionRecogida");
    }
    ...
    public void setDireccionRecogida(Direccion direccionRecogida) {
        ...
        try {
            Pedido ped = (Pedido) query.get(this.getObjectId());
            ped.put("direccionRecogida", direccionRecogida);
            ped.save();
        } catch (ParseException ex) {
            ex.printStackTrace();
        }
